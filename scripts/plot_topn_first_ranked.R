...
plot(topn, stats[1,1:15], type="n", xlim=c(10,150), ylim=c(min(stats[,1:15]),max(stats[,1:15])), ylab="First ranked loss", xlab="Top N models", xaxt='n')
...
legend("topleft",labels, lty=2, pch=stats$pch, cex=0.4, col=stats$col)
dev.off()
