...
for i in topn_sorted_ours_out/*topn_spearman.tsv topn_sorted_ours_out/*topn_pearson.tsv  ; do Rscript scripts/plot_topn_corr.R $i $i.pdf; done
for i in topn_sorted_ours_out/*topn_average_losses.tsv  ; do Rscript scripts/plot_topn_first_ranked.R $i $i.pdf; done
